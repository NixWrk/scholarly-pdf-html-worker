...
from pdf_html_polish.quality_loop.audit_blocks import Defect, snippet
from pdf_html_polish.quality_loop.audit_diagnostics import make_defect
from pdf_html_polish.quality_loop.audit_manual_patterns import replacement_chars_are_pdf_source_noise
