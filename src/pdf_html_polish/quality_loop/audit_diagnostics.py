...
DIAGNOSTIC_SPECS: dict[str, DiagnosticSpec] = {
    ...
    "P45M": DiagnosticSpec(
        id="P45M",
        detector="_roman_word_split_defects",
        summary="Roman-like suffix is a rendered math variable.",
        audit_signal="Classifies visible roman suffix splits whose raw HTML shows a nearby math span.",
        repair_hint="Accepted telemetry or roman-suffix/math-span guard.",
        quality_counted_by_default=False,
    ),
    "P45S": DiagnosticSpec(
        id="P45S",
        detector="_roman_word_split_defects",
        summary="Roman-like suffix is already a superscript marker.",
        audit_signal="Classifies visible roman suffix splits whose raw HTML shows a sup marker boundary.",
        repair_hint="Accepted telemetry or front-matter/footnote marker rendering guard.",
        quality_counted_by_default=False,
    ),
    "P61": DiagnosticSpec(
        id="P61",
